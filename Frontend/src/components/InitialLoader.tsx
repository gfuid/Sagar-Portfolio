...
export const InitialLoader: React.FC<{ onComplete?: () => void }> = ({
  onComplete,
}) => {
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#070709] text-white transition-all duration-700 select-none ${
      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="w-48 sm:w-72 mt-8 space-y-2">
          <div className="w-full h-1 bg-zinc-900/90 border border-red-900/30 rounded-full overflow-hidden">
            <div
              className="h-full bg-gradient-to-r from-red-600 via-rose-500 to-red-400 rounded-full transition-all duration-150 ease-out shadow-[0_0_12px_rgba(225,29,72,0.8)]"
